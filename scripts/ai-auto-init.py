...
class AIAutoInitializer:
    ...
    def _load_project_context(self) -> Dict:
        ...
        try:
            ...
            if context_file.exists():
                ...
                return {"success": False, "error": "无法生成或读取上下文文件"}

        except Exception as e:
            return {"success": False, "error": f"上下文加载失败: {e}"}
    ...
    def _run_diagnostics(self) -> Dict:
        ...
        try:
            ...
            if report_file.exists():
                ...
                return {"success": success, "message": "🩺 诊断运行完成,但无详细报告"}

        except Exception as e:
            return {"success": False, "error": f"诊断失败: {e}"}
    ...
    def _validate_context(self) -> Dict:
        ...
        try:
            ...
            return {"success": False, "error": f"上下文验证失败: {e}"}

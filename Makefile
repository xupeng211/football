...
# ==============================================================================
.PHONY: show.context regen.context diagnose-ci validate-context ai-start
...
ai-start: check-venv ## 🤖 AI工具自动初始化 - 获取完整上下文和诊断信息
	@echo "$(BLUE)🤖 AI工具自动初始化...$(NC)"
	@$(PYTHON_VENV) scripts/ai-auto-init.py

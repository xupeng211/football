...
class TestDataService:
    ...
    async def test_get_match_by_id_cache_hit(self):
        ...
        with patch(
            ...
            result = await service.get_match_by_id("123e4567-e89b-12d3-a456-426614174000")
            ...
            mock_cache_manager.get.assert_called_once_with("match:123e4567-e89b-12d3-a456-426614174000", "matches")
        ...
        with patch(
            ...
            with patch.object(service, "_load_match_from_db") as mock_load_db:
                ...
                mock_cache_manager.get.assert_called_once_with(
                    "match:123e4567-e89b-12d3-a456-426614174000", "matches"
                )
                ...
                assert call_args[0][0] == "match:123e4567-e89b-12d3-a456-426614174000"  # Cache key
    ...
    async def test_get_team_by_id_cache_hit(self):
        ...
        with patch(
            ...
            # Don't mock Team class, test with actual Team validation
            result = await service.get_team_by_id(
                "123e4567-e89b-12d3-a456-426614174000"
            )

            assert result.name == "Team A"
            assert result.short_name == "TMA"
            assert str(result.id) == "123e4567-e89b-12d3-a456-426614174000"
            mock_cache_manager.get.assert_called_once_with(
                "team:123e4567-e89b-12d3-a456-426614174000", "teams"
            )
    ...
    async def test_get_upcoming_matches_cache_hit(self):
        ...
        with patch(
            ...
            # Don't mock Match class, test with actual Match validation
            result = await service.get_upcoming_matches(5)

            assert len(result) == 2
            assert result[0].competition == "Premier League"
            assert result[1].competition == "Premier League"
            mock_cache_manager.get.assert_called_once_with(
    ...
    async def test_load_match_from_db_placeholder(self):
        ...
        result = await service._load_match_from_db("123e4567-e89b-12d3-a456-426614174000")
    ...
    async def test_load_team_from_db_placeholder(self):
        ...
        result = await service._load_team_from_db(
            "123e4567-e89b-12d3-a456-426614174000"
        )
    ...
    async def test_cache_ttl_values(self):
        ...
        mock_match.dict.return_value = {"id": "123e4567-e89b-12d3-a456-426614174000"}
        ...
        with patch(
            ...
            with (
                ...
                await service.get_match_by_id("123e4567-e89b-12d3-a456-426614174000")
    ...
    async def test_performance_decorators_present(self):
        ...
        with patch(
            ...
            with (
                ...
                result1 = await service.get_match_by_id("123e4567-e89b-12d3-a456-426614174000")
                result2 = await service.get_team_by_id(
                    "123e4567-e89b-12d3-a456-426614174000"
                )
    ...
    async def test_integration_scenario(self):
        ...
        mock_cache_manager.get.side_effect = [
            ...
            {  # team hit (second call)
                "id": "123e4567-e89b-12d3-a456-426614174000",
                "name": "Team A",
                "short_name": "TMA",
                "tla": "TMA"
            },
            [{  # upcoming hit (second call)
                "id": "123e4567-e89b-12d3-a456-426614174003",
                "home_team_id": "123e4567-e89b-12d3-a456-426614174001",
                "away_team_id": "123e4567-e89b-12d3-a456-426614174002",
                "competition": "Premier League",
                "season": "2023-24",
                "scheduled_date": "2023-10-02T15:00:00"
            }]
        ]

        # Mock database results
        mock_match = MagicMock()
        mock_match.dict.return_value = {"id": "123e4567-e89b-12d3-a456-426614174000", "home_team": "Team A"}
